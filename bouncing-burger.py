...
class BouncingBurgerApp:
    def __init__(self, root):
        ...
        # Add background watermark text (fixed, does NOT move)
        self.bg_text = self.canvas.create_text(
            self.canvas_width // 2,
            self.canvas_height // 2,
            text="JOHN RAVE REQUINA",
            font=("Arial", 40, "bold"),
            fill="#dddddd",  # light gray for watermark effect
            anchor="center"
        )
        ...
        # Add image to canvas (in front of background text)
